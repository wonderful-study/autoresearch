...
> Drop this file into your project root. Codex can then use Autoresearch immediately.
...
Copy the skill files into your Codex skill directory:
...
├── COMPARISON.md                      ← Karpathy's vs Codex Autoresearch
